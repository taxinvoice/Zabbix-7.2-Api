...
public class ItemPrototype : BaseEntity
{
    ...
    public IList<ItemPreprocessing>? Preprocessings { get; set; }
    [JsonProperty("valuemap")]
    public IList<ValueMap>? ValueMaps { get; set; }
    [JsonProperty("graph_prototype")]
    public IList<GraphPrototype>? GraphPrototypes { get; set; } // TODO might be wrong check this
...
public class ItemPrototypeTag
{
    ...
    public ItemPrototypeTag(string tag) => Tag = tag;
