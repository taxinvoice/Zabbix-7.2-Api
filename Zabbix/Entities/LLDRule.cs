...
public class LldRule : BaseEntity
{
    ...
    [JsonProperty("filter")]
    public IList<LldRuleFilter>? Filters { get; set; }
    [JsonProperty("graphs")]
    public IList<Graph>? Graphs { get; set; }
    [JsonProperty("hostPrototypes")]
    ...
    [JsonProperty("lld_macro_paths")]
    public IList<LLdMacroPath>? LLdMacroPaths { get; set; }
    [JsonProperty("preprocessing")]
    public IList<LLdRulePreprocessing>? LLdRulePreprocessings { get; set; }
    [JsonProperty("lld_rule_overrides")]
    public IList<LldRuleOverride>? LLdRuleOverrides { get; set; }
...
public class LldRuleOverrideOperation
{
    ...
    public LldRuleOverrideOperation(int operationObject) => OperationObject = operationObject;
...
public class LLDRuleOverrideOperationStatus
{
    ...
    public LLDRuleOverrideOperationStatus(int status) => Status = status;
...
public class LLDRuleOverrideOperationDiscover
{
    ...
    public LLDRuleOverrideOperationDiscover(int discover) => Discover = discover;
...
public class LLDRuleOverrideOperationPeriod
{
    ...
    public LLDRuleOverrideOperationPeriod(string delay) => Delay = delay;
...
public class LLDRuleOverrideOperationHistory
{
    ...
    public LLDRuleOverrideOperationHistory(string history) => History = history;
...
public class LLDRuleOverrideOperationTrends
{
    ...
    public LLDRuleOverrideOperationTrends(string trends) => Trends = trends;
...
public class LLDRuleOverrideOperationSeverity
{
    ...
    public LLDRuleOverrideOperationSeverity(int severity) => Severity = severity;
...
public class LLDRuleOverrideOperationTag
{
    ...
    public LLDRuleOverrideOperationTag(string? tag) => Tag = tag;
...
public class LLDRuleOverrideOperationInventory
{
    ...
    public LLDRuleOverrideOperationInventory(int inventoryMode) => InventoryMode = inventoryMode;
