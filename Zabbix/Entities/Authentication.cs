...
public class Authentication : BaseEntity
{
    ...
    public int? SamlSignMessages { get; set; }

    [JsonProperty("saml_sign_assertions")]
    public int? SamlSignAssertions { get; set; }
