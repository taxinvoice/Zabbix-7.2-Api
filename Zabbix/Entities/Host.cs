...
public class Host : BaseEntity
{
    ...
    [JsonProperty("groups")]
    public IList<HostGroupReference>? Groups { get; set; }
    ...
    [JsonProperty("hostDiscovery")]
    public object? HostDiscovery { get; set; } // TODO map this to actual object
    ...
    public IList<Tag>? InheritedTags { get; set; }
    ...
    public Host(string hostName, IList<HostGroupReference> groups)
    {
        host = hostName;
        Groups = groups;
    }

    public Host(string hostName, HostGroupReference group)
    {
        host = hostName;
        Groups = new List<HostGroupReference>() { group };
    }
