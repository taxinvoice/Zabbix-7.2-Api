...
public class Service : BaseEntity
{
    ...
    public IList<Service>? Children { get; set; }
    [JsonProperty("parents")]
    public IList<Service>? Parents { get; set; }
    [JsonProperty("tags")]
    public IList<Tag>? Tags { get; set; }
    [JsonProperty("problem_events")]
    public IList<ProblemEvent>? ProblemEvents { get; set; }
    [JsonProperty("problem_tags")]
    public IList<ProblemTag>? ProblemTags { get; set; }
    [JsonProperty("status_rules")]
    public IList<StatusRule>? StatusRules { get; set; }
    [JsonProperty("status_timeline")]
    public object? StatusTimeline { get; set; } // TODO maybe map this to actual class
...
public class ProblemTag : Tag
{
    ...
    #region Construcors
    public ProblemTag(string tagName, string value)
        : base(tagName, value)
    {
    }
    #endregion
