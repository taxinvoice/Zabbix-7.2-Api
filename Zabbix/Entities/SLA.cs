...
public class SLA : BaseEntity
{
    ...
    public IList<SLAExcludedDowntime>? ExcludedDowntimes { get; set; }
    [JsonProperty("service_tags")]
    public IList<SLAServiceTag>? Tags { get; set; }
    [JsonProperty("schedule")]
    public IList<SLASchedule>? Schedules { get; set; }
...
public class SLAServiceTag : Tag
{
    ...
    #region Constructors
    public SLAServiceTag(string tagName, string value, int operatr) : base(tagName, value) { Operator = operatr; }
