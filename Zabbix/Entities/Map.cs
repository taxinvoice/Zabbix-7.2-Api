...
public class Map : BaseEntity
{
    ...
    public IList<IconMap>? IconMaps { get; set; }
    [JsonProperty("links")]
    public IList<MapLink>? MapLinks { get; set; }
    [JsonProperty("selements")]
    public IList<MapElement>? MapElements { get; set; }
    [JsonProperty("urls")]
    public IList<MapUrl>? MapUrls { get; set; }
    [JsonProperty("users")]
    public IList<MapUser>? MapUsers { get; set; }
    [JsonProperty("userGroups")]
    public IList<MapUserGroup>? MapUserGroups { get; set; }
    [JsonProperty("shapes")]
    public IList<MapShape>? Shapes { get; set; }
    [JsonProperty("lines")]
...
public class MapElementTag : ElementData
{
    ...
    public MapElementTag(string? tagName) => TagName = tagName;
...
public class MapLinkTrigger
{
    ...
    public MapLinkTrigger(string? triggerId) => TriggerId = triggerId;
...
public class MapShape
{
    ...
    public MapShape(int? type) => Type = type;
