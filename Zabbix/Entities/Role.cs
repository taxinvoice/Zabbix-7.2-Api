...
public class RoleRuleService
{
    ...
    public RoleRuleService(string serviceId) => ServiceId = serviceId;
...
public class Module
{
    ...
    #region Constructors
    public Module(string moduleId) => ModuleId = moduleId;
...
public class UiElement
{
    ...
    public UiElement(string name) => Name = name;
...
public class RoleAction
{
    ...
    public RoleAction(string name) => Name = name;
