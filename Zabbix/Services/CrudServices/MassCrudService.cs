...
public interface IMassAdd<TEntity>
...
public interface IMassRemove<TEntity>
    where TEntity : BaseEntity
{
...
public interface IMassUpdate<TEntity>
    where TEntity : BaseEntity
{
...
{
    public MassCrudService(ICore core, string className)
        : base(core, className)
    {
    }
